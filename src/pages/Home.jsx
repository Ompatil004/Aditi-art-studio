...
const Home = () => {
  ...
  useEffect(() => {
    ...
    setCategoryBgs(getRandomBackgrounds(categories?.length || 0));
    setTestimonialBg(getRandomBackground());
  }, [categories?.length]);

  // If categories are loading, show a spinner
  if (loading) {
    return (
  ...
  return (
    <div style={{ backgroundColor: theme.background, minHeight: '100vh', padding: '0' }}>
          ...
          <Row xs={1} md={2} lg={3} className="g-4">
            {categories && categories.length > 0 ? (
              categories.map((category, index) => (
                <Col key={category._id || category.id}>
                  <Card
                    style={{
                      height: '100%',
                      borderRadius: '10px',
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        width: '100%',
                        height: '200px',
                        backgroundImage: `url(${category.image || categoryBgs[index] || 'https://placehold.co/400x200'})`,
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        opacity: 0.7,
                        zIndex: 0
              ...
              <Col>
                <div className="text-center py-5">
                  ...
                  <p>Check back soon for our art collections.</p>
                </div>
              </Col>
            )}
          </Row>
          ...
          <Row>
            <Col lg={6} style={{ display: 'flex', alignItems: 'center' }}>
              <div style={{ padding: '2rem' }}>
                ...
                <p style={{ fontSize: '1.1rem', color: theme.textLight, lineHeight: '1.7' }}>
      ...
      <section style={{ padding: '4rem 0', backgroundColor: theme.highlight }}>
        <Container>
          <h2 style={{
            textAlign: 'center',
            fontFamily: 'serif',
      ...
      <section style={{ padding: '4rem 0', backgroundColor: theme.highlight, position: 'relative' }}>
        {/* Random background image */}
        <div
          style={{
            position: 'absolute',
